...
public partial class JassParser : Parser {
	...
	public const int
		...
		RULE_func = 9, RULE_localVarList = 10, RULE_varDeclr = 11, RULE_statementList = 12, 
		RULE_statement = 13, RULE_set = 14, RULE_call = 15, RULE_args = 16, RULE_ifthenelse = 17, 
		RULE_elseClause = 18, RULE_loop = 19, RULE_exitwhen = 20, RULE_returnStat = 21, 
		RULE_debug = 22, RULE_expr = 23, RULE_funcCall = 24, RULE_arrayRef = 25, 
		RULE_funcRef = 26, RULE_constant = 27, RULE_intConst = 28, RULE_decimal = 29, 
		RULE_hex = 30, RULE_parens = 31, RULE_boolConst = 32, RULE_stringConst = 33, 
		RULE_type = 34, RULE_id = 35;
	public static readonly string[] ruleNames = {
		"file", "declr", "typedef", "globals", "globalVarList", "constDeclr", 
		"nativeFunc", "funcDeclr", "paramList", "func", "localVarList", "varDeclr", 
		"statementList", "statement", "set", "call", "args", "ifthenelse", "elseClause", 
		"loop", "exitwhen", "returnStat", "debug", "expr", "funcCall", "arrayRef", 
		"funcRef", "constant", "intConst", "decimal", "hex", "parens", "boolConst", 
		"stringConst", "type", "id"
	};
	...
	public TypedefContext typedef() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 89; Match(K_TYPE);
			State = 90; id();
			State = 91; Match(K_EXTENDS);
			State = 94;
			ErrorHandler.Sync(this);
			switch (TokenStream.LA(1)) {
			case K_HANDLE:
				{
				State = 92; Match(K_HANDLE);
				}
				break;
			case ID:
				{
	...
	public GlobalsContext globals() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 96; Match(K_GLOBALS);
			State = 97; globalVarList();
			State = 98; Match(K_ENDGLOBALS);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public NativeFuncContext nativeFunc() {
		...
		try {
			...
			if (_la==K_CONSTANT) {
				{
				State = 113; Match(K_CONSTANT);
				}
			}

			State = 116; Match(K_NATIVE);
			State = 117; funcDeclr();
			}
		}
		catch (RecognitionException re) {
	...
	public FuncDeclrContext funcDeclr() {
		...
		try {
			...
			{
			State = 119; id();
			State = 120; Match(K_TAKES);
			State = 123;
			ErrorHandler.Sync(this);
			switch (TokenStream.LA(1)) {
			case K_NOTHING:
				{
				State = 121; Match(K_NOTHING);
				}
				break;
			case K_CODE:
			case K_HANDLE:
	...
	public FuncContext func() {
		...
		try {
			...
			if (_la==K_CONSTANT) {
				{
				State = 141; Match(K_CONSTANT);
				}
			}

			State = 144; Match(K_FUNCTION);
			State = 145; funcDeclr();
			State = 146; localVarList();
			State = 147; statementList();
			State = 148; Match(K_ENDFUNCTION);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public VarDeclrContext varDeclr() {
		...
		EnterRule(_localctx, 22, RULE_varDeclr);
		int _la;
		try {
			State = 167;
			ErrorHandler.Sync(this);
	...
	public IfthenelseContext ifthenelse() {
		...
		try {
			...
			State = 218; statementList();
			State = 220;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if (_la==K_ELSEIF || _la==K_ELSE) {
				{
				State = 219; elseClause();
				}
			}
	...
	public ExitwhenContext exitwhen() {
		...
		EnterRule(_localctx, 40, RULE_exitwhen);
		try {
			EnterOuterAlt(_localctx, 1);
			{
	...
	public DebugContext debug() {
		...
		EnterRule(_localctx, 44, RULE_debug);
		try {
			EnterOuterAlt(_localctx, 1);
			{
	...
	public IntConstContext intConst() {
		...
		EnterRule(_localctx, 56, RULE_intConst);
		try {
			State = 314;
			ErrorHandler.Sync(this);
			switch (TokenStream.LA(1)) {
	...
	public ParensContext parens() {
		...
		EnterRule(_localctx, 62, RULE_parens);
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 320; Match(O_PAR);
			State = 321; expr(0);
			State = 322; Match(C_PAR);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public BoolConstContext boolConst() {
		...
		EnterRule(_localctx, 64, RULE_boolConst);
		int _la;
		try {
			EnterOuterAlt(_localctx, 1);
			{
	...
	public StringConstContext stringConst() {
		...
		EnterRule(_localctx, 66, RULE_stringConst);
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 326; Match(STRING_CONST);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public TypeContext type() {
		...
		try {
			...
			case K_CODE:
				EnterOuterAlt(_localctx, 2);
				{
				State = 329; Match(K_CODE);
				}
				break;
			case K_HANDLE:
				EnterOuterAlt(_localctx, 3);
				{
				State = 330; Match(K_HANDLE);
				}
				break;
			case K_INTEGER:
				EnterOuterAlt(_localctx, 4);
				{
				State = 331; Match(K_INTEGER);
				}
				break;
			case K_REAL:
				EnterOuterAlt(_localctx, 5);
				{
				State = 332; Match(K_REAL);
				}
				break;
			case K_BOOLEAN:
				EnterOuterAlt(_localctx, 6);
				{
				State = 333; Match(K_BOOLEAN);
				}
				break;
			case K_STRING:
				EnterOuterAlt(_localctx, 7);
				{
				State = 334; Match(K_STRING);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	private static char[] _serializedATN = {
		...
		'\x3', '\x2', '\a', '\x2', 'R', '\n', '\x2', '\f', '\x2', '\xE', '\x2', 
		'U', '\v', '\x2', '\x3', '\x3', '\x3', '\x3', '\x3', '\x3', '\x5', '\x3', 
		...
		'\x2', '\t', '\n', '\x2', '\x16C', '\x2', 'M', '\x3', '\x2', '\x2', '\x2', 
		'\x4', 'Y', '\x3', '\x2', '\x2', '\x2', '\x6', '[', '\x3', '\x2', '\x2', 
		'\x2', '\b', '\x62', '\x3', '\x2', '\x2', '\x2', '\n', 'j', '\x3', '\x2', 
		'\x2', '\x2', '\f', 'm', '\x3', '\x2', '\x2', '\x2', '\xE', 't', '\x3', 
		'\x2', '\x2', '\x2', '\x10', 'y', '\x3', '\x2', '\x2', '\x2', '\x12', 
		'\x84', '\x3', '\x2', '\x2', '\x2', '\x14', '\x90', '\x3', '\x2', '\x2', 
		'\x2', '\x16', '\x9C', '\x3', '\x2', '\x2', '\x2', '\x18', '\xA9', '\x3', 
		'\x2', '\x2', '\x2', '\x1A', '\xAE', '\x3', '\x2', '\x2', '\x2', '\x1C', 
		'\xB8', '\x3', '\x2', '\x2', '\x2', '\x1E', '\xC7', '\x3', '\x2', '\x2', 
		'\x2', ' ', '\xC9', '\x3', '\x2', '\x2', '\x2', '\"', '\xD1', '\x3', '\x2', 
		'\x2', '\x2', '$', '\xD9', '\x3', '\x2', '\x2', '\x2', '&', '\xEB', '\x3', 
		'\x2', '\x2', '\x2', '(', '\xED', '\x3', '\x2', '\x2', '\x2', '*', '\xF1', 
		'\x3', '\x2', '\x2', '\x2', ',', '\xF4', '\x3', '\x2', '\x2', '\x2', '.', 
		'\xF8', '\x3', '\x2', '\x2', '\x2', '\x30', '\x10C', '\x3', '\x2', '\x2', 
		'\x2', '\x32', '\x122', '\x3', '\x2', '\x2', '\x2', '\x34', '\x129', '\x3', 
		'\x2', '\x2', '\x2', '\x36', '\x12E', '\x3', '\x2', '\x2', '\x2', '\x38', 
		'\x136', '\x3', '\x2', '\x2', '\x2', ':', '\x13C', '\x3', '\x2', '\x2', 
		'\x2', '<', '\x13E', '\x3', '\x2', '\x2', '\x2', '>', '\x140', '\x3', 
		'\x2', '\x2', '\x2', '@', '\x142', '\x3', '\x2', '\x2', '\x2', '\x42', 
		'\x146', '\x3', '\x2', '\x2', '\x2', '\x44', '\x148', '\x3', '\x2', '\x2', 
		'\x2', '\x46', '\x151', '\x3', '\x2', '\x2', '\x2', 'H', '\x153', '\x3', 
		'\x2', '\x2', '\x2', 'J', 'L', '\x5', '\x4', '\x3', '\x2', 'K', 'J', '\x3', 
		'\x2', '\x2', '\x2', 'L', 'O', '\x3', '\x2', '\x2', '\x2', 'M', 'K', '\x3', 
		'\x2', '\x2', '\x2', 'M', 'N', '\x3', '\x2', '\x2', '\x2', 'N', 'S', '\x3', 
		'\x2', '\x2', '\x2', 'O', 'M', '\x3', '\x2', '\x2', '\x2', 'P', 'R', '\x5', 
		'\x14', '\v', '\x2', 'Q', 'P', '\x3', '\x2', '\x2', '\x2', 'R', 'U', '\x3', 
		'\x2', '\x2', '\x2', 'S', 'Q', '\x3', '\x2', '\x2', '\x2', 'S', 'T', '\x3', 
		'\x2', '\x2', '\x2', 'T', '\x3', '\x3', '\x2', '\x2', '\x2', 'U', 'S', 
		'\x3', '\x2', '\x2', '\x2', 'V', 'Z', '\x5', '\x6', '\x4', '\x2', 'W', 
		'Z', '\x5', '\b', '\x5', '\x2', 'X', 'Z', '\x5', '\xE', '\b', '\x2', 'Y', 
		'V', '\x3', '\x2', '\x2', '\x2', 'Y', 'W', '\x3', '\x2', '\x2', '\x2', 
		'Y', 'X', '\x3', '\x2', '\x2', '\x2', 'Z', '\x5', '\x3', '\x2', '\x2', 
		'\x2', '[', '\\', '\a', '\x1D', '\x2', '\x2', '\\', ']', '\x5', 'H', '%', 
		'\x2', ']', '`', '\a', '\x1E', '\x2', '\x2', '^', '\x61', '\a', '\x4', 
		'\x2', '\x2', '_', '\x61', '\x5', 'H', '%', '\x2', '`', '^', '\x3', '\x2', 
		'\x2', '\x2', '`', '_', '\x3', '\x2', '\x2', '\x2', '\x61', '\a', '\x3', 
		'\x2', '\x2', '\x2', '\x62', '\x63', '\a', '\x1F', '\x2', '\x2', '\x63', 
		'\x64', '\x5', '\n', '\x6', '\x2', '\x64', '\x65', '\a', ' ', '\x2', '\x2', 
		'\x65', '\t', '\x3', '\x2', '\x2', '\x2', '\x66', 'i', '\x5', '\f', '\a', 
		'\x2', 'g', 'i', '\x5', '\x18', '\r', '\x2', 'h', '\x66', '\x3', '\x2', 
		'\x2', '\x2', 'h', 'g', '\x3', '\x2', '\x2', '\x2', 'i', 'l', '\x3', '\x2', 
		'\x2', '\x2', 'j', 'h', '\x3', '\x2', '\x2', '\x2', 'j', 'k', '\x3', '\x2', 
		'\x2', '\x2', 'k', '\v', '\x3', '\x2', '\x2', '\x2', 'l', 'j', '\x3', 
		'\x2', '\x2', '\x2', 'm', 'n', '\a', '!', '\x2', '\x2', 'n', 'o', '\x5', 
		'\x46', '$', '\x2', 'o', 'p', '\x5', 'H', '%', '\x2', 'p', 'q', '\a', 
		'\x37', '\x2', '\x2', 'q', 'r', '\x5', '\x30', '\x19', '\x2', 'r', '\r', 
		'\x3', '\x2', '\x2', '\x2', 's', 'u', '\a', '!', '\x2', '\x2', 't', 's', 
		'\x3', '\x2', '\x2', '\x2', 't', 'u', '\x3', '\x2', '\x2', '\x2', 'u', 
		'v', '\x3', '\x2', '\x2', '\x2', 'v', 'w', '\a', '\"', '\x2', '\x2', 'w', 
		'x', '\x5', '\x10', '\t', '\x2', 'x', '\xF', '\x3', '\x2', '\x2', '\x2', 
		'y', 'z', '\x5', 'H', '%', '\x2', 'z', '}', '\a', '#', '\x2', '\x2', '{', 
		'~', '\a', '$', '\x2', '\x2', '|', '~', '\x5', '\x12', '\n', '\x2', '}', 
		'{', '\x3', '\x2', '\x2', '\x2', '}', '|', '\x3', '\x2', '\x2', '\x2', 
		'~', '\x7F', '\x3', '\x2', '\x2', '\x2', '\x7F', '\x82', '\a', '\x11', 
		'\x2', '\x2', '\x80', '\x83', '\x5', '\x46', '$', '\x2', '\x81', '\x83', 
		'\a', '$', '\x2', '\x2', '\x82', '\x80', '\x3', '\x2', '\x2', '\x2', '\x82', 
		'\x81', '\x3', '\x2', '\x2', '\x2', '\x83', '\x11', '\x3', '\x2', '\x2', 
		'\x2', '\x84', '\x85', '\x5', '\x46', '$', '\x2', '\x85', '\x8C', '\x5', 
		'H', '%', '\x2', '\x86', '\x87', '\a', '\x36', '\x2', '\x2', '\x87', '\x88', 
		'\x5', '\x46', '$', '\x2', '\x88', '\x89', '\x5', 'H', '%', '\x2', '\x89', 
		'\x8B', '\x3', '\x2', '\x2', '\x2', '\x8A', '\x86', '\x3', '\x2', '\x2', 
		'\x2', '\x8B', '\x8E', '\x3', '\x2', '\x2', '\x2', '\x8C', '\x8A', '\x3', 
		'\x2', '\x2', '\x2', '\x8C', '\x8D', '\x3', '\x2', '\x2', '\x2', '\x8D', 
		'\x13', '\x3', '\x2', '\x2', '\x2', '\x8E', '\x8C', '\x3', '\x2', '\x2', 
		'\x2', '\x8F', '\x91', '\a', '!', '\x2', '\x2', '\x90', '\x8F', '\x3', 
		'\x2', '\x2', '\x2', '\x90', '\x91', '\x3', '\x2', '\x2', '\x2', '\x91', 
		'\x92', '\x3', '\x2', '\x2', '\x2', '\x92', '\x93', '\a', '\xF', '\x2', 
		'\x2', '\x93', '\x94', '\x5', '\x10', '\t', '\x2', '\x94', '\x95', '\x5', 
		'\x16', '\f', '\x2', '\x95', '\x96', '\x5', '\x1A', '\xE', '\x2', '\x96', 
		'\x97', '\a', '%', '\x2', '\x2', '\x97', '\x15', '\x3', '\x2', '\x2', 
		'\x2', '\x98', '\x99', '\a', '&', '\x2', '\x2', '\x99', '\x9B', '\x5', 
		'\x18', '\r', '\x2', '\x9A', '\x98', '\x3', '\x2', '\x2', '\x2', '\x9B', 
		'\x9E', '\x3', '\x2', '\x2', '\x2', '\x9C', '\x9A', '\x3', '\x2', '\x2', 
		'\x2', '\x9C', '\x9D', '\x3', '\x2', '\x2', '\x2', '\x9D', '\x17', '\x3', 
		'\x2', '\x2', '\x2', '\x9E', '\x9C', '\x3', '\x2', '\x2', '\x2', '\x9F', 
		'\xA0', '\x5', '\x46', '$', '\x2', '\xA0', '\xA3', '\x5', 'H', '%', '\x2', 
		'\xA1', '\xA2', '\a', '\x37', '\x2', '\x2', '\xA2', '\xA4', '\x5', '\x30', 
		'\x19', '\x2', '\xA3', '\xA1', '\x3', '\x2', '\x2', '\x2', '\xA3', '\xA4', 
		'\x3', '\x2', '\x2', '\x2', '\xA4', '\xAA', '\x3', '\x2', '\x2', '\x2', 
		'\xA5', '\xA6', '\x5', '\x46', '$', '\x2', '\xA6', '\xA7', '\a', '\'', 
		'\x2', '\x2', '\xA7', '\xA8', '\x5', 'H', '%', '\x2', '\xA8', '\xAA', 
		'\x3', '\x2', '\x2', '\x2', '\xA9', '\x9F', '\x3', '\x2', '\x2', '\x2', 
		'\xA9', '\xA5', '\x3', '\x2', '\x2', '\x2', '\xAA', '\x19', '\x3', '\x2', 
		'\x2', '\x2', '\xAB', '\xAD', '\x5', '\x1C', '\xF', '\x2', '\xAC', '\xAB', 
		'\x3', '\x2', '\x2', '\x2', '\xAD', '\xB0', '\x3', '\x2', '\x2', '\x2', 
		'\xAE', '\xAC', '\x3', '\x2', '\x2', '\x2', '\xAE', '\xAF', '\x3', '\x2', 
		'\x2', '\x2', '\xAF', '\x1B', '\x3', '\x2', '\x2', '\x2', '\xB0', '\xAE', 
		'\x3', '\x2', '\x2', '\x2', '\xB1', '\xB9', '\x5', '\x1E', '\x10', '\x2', 
		'\xB2', '\xB9', '\x5', ' ', '\x11', '\x2', '\xB3', '\xB9', '\x5', '$', 
		'\x13', '\x2', '\xB4', '\xB9', '\x5', '(', '\x15', '\x2', '\xB5', '\xB9', 
		'\x5', '*', '\x16', '\x2', '\xB6', '\xB9', '\x5', ',', '\x17', '\x2', 
		'\xB7', '\xB9', '\x5', '.', '\x18', '\x2', '\xB8', '\xB1', '\x3', '\x2', 
		'\x2', '\x2', '\xB8', '\xB2', '\x3', '\x2', '\x2', '\x2', '\xB8', '\xB3', 
		'\x3', '\x2', '\x2', '\x2', '\xB8', '\xB4', '\x3', '\x2', '\x2', '\x2', 
		'\xB8', '\xB5', '\x3', '\x2', '\x2', '\x2', '\xB8', '\xB6', '\x3', '\x2', 
		'\x2', '\x2', '\xB8', '\xB7', '\x3', '\x2', '\x2', '\x2', '\xB9', '\x1D', 
		'\x3', '\x2', '\x2', '\x2', '\xBA', '\xBB', '\a', '\x1C', '\x2', '\x2', 
		'\xBB', '\xBC', '\x5', 'H', '%', '\x2', '\xBC', '\xBD', '\a', '\x37', 
		'\x2', '\x2', '\xBD', '\xBE', '\x5', '\x30', '\x19', '\x2', '\xBE', '\xC8', 
		'\x3', '\x2', '\x2', '\x2', '\xBF', '\xC0', '\a', '\x1C', '\x2', '\x2', 
		'\xC0', '\xC1', '\x5', 'H', '%', '\x2', '\xC1', '\xC2', '\a', '\x32', 
		'\x2', '\x2', '\xC2', '\xC3', '\x5', '\x30', '\x19', '\x2', '\xC3', '\xC4', 
		'\a', '\x33', '\x2', '\x2', '\xC4', '\xC5', '\a', '\x37', '\x2', '\x2', 
		'\xC5', '\xC6', '\x5', '\x30', '\x19', '\x2', '\xC6', '\xC8', '\x3', '\x2', 
		'\x2', '\x2', '\xC7', '\xBA', '\x3', '\x2', '\x2', '\x2', '\xC7', '\xBF', 
		'\x3', '\x2', '\x2', '\x2', '\xC8', '\x1F', '\x3', '\x2', '\x2', '\x2', 
		'\xC9', '\xCA', '\a', '\x17', '\x2', '\x2', '\xCA', '\xCB', '\x5', 'H', 
		'%', '\x2', '\xCB', '\xCD', '\a', '\x34', '\x2', '\x2', '\xCC', '\xCE', 
		'\x5', '\"', '\x12', '\x2', '\xCD', '\xCC', '\x3', '\x2', '\x2', '\x2', 
		'\xCD', '\xCE', '\x3', '\x2', '\x2', '\x2', '\xCE', '\xCF', '\x3', '\x2', 
		'\x2', '\x2', '\xCF', '\xD0', '\a', '\x35', '\x2', '\x2', '\xD0', '!', 
		'\x3', '\x2', '\x2', '\x2', '\xD1', '\xD6', '\x5', '\x30', '\x19', '\x2', 
		'\xD2', '\xD3', '\a', '\x36', '\x2', '\x2', '\xD3', '\xD5', '\x5', '\x30', 
		'\x19', '\x2', '\xD4', '\xD2', '\x3', '\x2', '\x2', '\x2', '\xD5', '\xD8', 
		'\x3', '\x2', '\x2', '\x2', '\xD6', '\xD4', '\x3', '\x2', '\x2', '\x2', 
		'\xD6', '\xD7', '\x3', '\x2', '\x2', '\x2', '\xD7', '#', '\x3', '\x2', 
		'\x2', '\x2', '\xD8', '\xD6', '\x3', '\x2', '\x2', '\x2', '\xD9', '\xDA', 
		'\a', '\x18', '\x2', '\x2', '\xDA', '\xDB', '\x5', '\x30', '\x19', '\x2', 
		'\xDB', '\xDC', '\a', '\x19', '\x2', '\x2', '\xDC', '\xDE', '\x5', '\x1A', 
		'\xE', '\x2', '\xDD', '\xDF', '\x5', '&', '\x14', '\x2', '\xDE', '\xDD', 
		'\x3', '\x2', '\x2', '\x2', '\xDE', '\xDF', '\x3', '\x2', '\x2', '\x2', 
		'\xDF', '\xE0', '\x3', '\x2', '\x2', '\x2', '\xE0', '\xE1', '\a', '\x1A', 
		'\x2', '\x2', '\xE1', '%', '\x3', '\x2', '\x2', '\x2', '\xE2', '\xE3', 
		'\a', '\x16', '\x2', '\x2', '\xE3', '\xEC', '\x5', '\x1A', '\xE', '\x2', 
		'\xE4', '\xE5', '\a', '\x15', '\x2', '\x2', '\xE5', '\xE6', '\x5', '\x30', 
		'\x19', '\x2', '\xE6', '\xE7', '\a', '\x19', '\x2', '\x2', '\xE7', '\xE9', 
		'\x5', '\x1A', '\xE', '\x2', '\xE8', '\xEA', '\x5', '&', '\x14', '\x2', 
		'\xE9', '\xE8', '\x3', '\x2', '\x2', '\x2', '\xE9', '\xEA', '\x3', '\x2', 
		'\x2', '\x2', '\xEA', '\xEC', '\x3', '\x2', '\x2', '\x2', '\xEB', '\xE2', 
		'\x3', '\x2', '\x2', '\x2', '\xEB', '\xE4', '\x3', '\x2', '\x2', '\x2', 
		'\xEC', '\'', '\x3', '\x2', '\x2', '\x2', '\xED', '\xEE', '\a', '\x13', 
		'\x2', '\x2', '\xEE', '\xEF', '\x5', '\x1A', '\xE', '\x2', '\xEF', '\xF0', 
		'\a', '\x14', '\x2', '\x2', '\xF0', ')', '\x3', '\x2', '\x2', '\x2', '\xF1', 
		'\xF2', '\a', '\x12', '\x2', '\x2', '\xF2', '\xF3', '\x5', '\x30', '\x19', 
		'\x2', '\xF3', '+', '\x3', '\x2', '\x2', '\x2', '\xF4', '\xF6', '\a', 
		'\x10', '\x2', '\x2', '\xF5', '\xF7', '\x5', '\x30', '\x19', '\x2', '\xF6', 
		'\xF5', '\x3', '\x2', '\x2', '\x2', '\xF6', '\xF7', '\x3', '\x2', '\x2', 
		'\x2', '\xF7', '-', '\x3', '\x2', '\x2', '\x2', '\xF8', '\xFD', '\a', 
		'\x1B', '\x2', '\x2', '\xF9', '\xFE', '\x5', '\x1E', '\x10', '\x2', '\xFA', 
		'\xFE', '\x5', ' ', '\x11', '\x2', '\xFB', '\xFE', '\x5', '$', '\x13', 
		'\x2', '\xFC', '\xFE', '\x5', '(', '\x15', '\x2', '\xFD', '\xF9', '\x3', 
		'\x2', '\x2', '\x2', '\xFD', '\xFA', '\x3', '\x2', '\x2', '\x2', '\xFD', 
		'\xFB', '\x3', '\x2', '\x2', '\x2', '\xFD', '\xFC', '\x3', '\x2', '\x2', 
		'\x2', '\xFE', '/', '\x3', '\x2', '\x2', '\x2', '\xFF', '\x100', '\b', 
		'\x19', '\x1', '\x2', '\x100', '\x101', '\a', '(', '\x2', '\x2', '\x101', 
		'\x10D', '\x5', '\x30', '\x19', '\x10', '\x102', '\x103', '\a', ')', '\x2', 
		'\x2', '\x103', '\x10D', '\x5', '\x30', '\x19', '\xF', '\x104', '\x105', 
		'\a', '\f', '\x2', '\x2', '\x105', '\x10D', '\x5', '\x30', '\x19', '\xE', 
		'\x106', '\x10D', '\x5', '\x32', '\x1A', '\x2', '\x107', '\x10D', '\x5', 
		'\x34', '\x1B', '\x2', '\x108', '\x10D', '\x5', '\x36', '\x1C', '\x2', 
		'\x109', '\x10D', '\x5', 'H', '%', '\x2', '\x10A', '\x10D', '\x5', '\x38', 
		'\x1D', '\x2', '\x10B', '\x10D', '\x5', '@', '!', '\x2', '\x10C', '\xFF', 
		'\x3', '\x2', '\x2', '\x2', '\x10C', '\x102', '\x3', '\x2', '\x2', '\x2', 
		'\x10C', '\x104', '\x3', '\x2', '\x2', '\x2', '\x10C', '\x106', '\x3', 
		'\x2', '\x2', '\x2', '\x10C', '\x107', '\x3', '\x2', '\x2', '\x2', '\x10C', 
		'\x108', '\x3', '\x2', '\x2', '\x2', '\x10C', '\x109', '\x3', '\x2', '\x2', 
		'\x2', '\x10C', '\x10A', '\x3', '\x2', '\x2', '\x2', '\x10C', '\x10B', 
		'\x3', '\x2', '\x2', '\x2', '\x10D', '\x11F', '\x3', '\x2', '\x2', '\x2', 
		'\x10E', '\x10F', '\f', '\r', '\x2', '\x2', '\x10F', '\x110', '\t', '\x2', 
		'\x2', '\x2', '\x110', '\x11E', '\x5', '\x30', '\x19', '\xE', '\x111', 
		'\x112', '\f', '\f', '\x2', '\x2', '\x112', '\x113', '\t', '\x3', '\x2', 
		'\x2', '\x113', '\x11E', '\x5', '\x30', '\x19', '\r', '\x114', '\x115', 
		'\f', '\v', '\x2', '\x2', '\x115', '\x116', '\t', '\x4', '\x2', '\x2', 
		'\x116', '\x11E', '\x5', '\x30', '\x19', '\f', '\x117', '\x118', '\f', 
		'\n', '\x2', '\x2', '\x118', '\x119', '\t', '\x5', '\x2', '\x2', '\x119', 
		'\x11E', '\x5', '\x30', '\x19', '\v', '\x11A', '\x11B', '\f', '\t', '\x2', 
		...
		'\x3', '\x2', '\x2', '\x2', '\x120', '\x31', '\x3', '\x2', '\x2', '\x2', 
		'\x121', '\x11F', '\x3', '\x2', '\x2', '\x2', '\x122', '\x123', '\x5', 
		'H', '%', '\x2', '\x123', '\x125', '\a', '\x34', '\x2', '\x2', '\x124', 
		'\x126', '\x5', '\"', '\x12', '\x2', '\x125', '\x124', '\x3', '\x2', '\x2', 
		'\x2', '\x125', '\x126', '\x3', '\x2', '\x2', '\x2', '\x126', '\x127', 
		'\x3', '\x2', '\x2', '\x2', '\x127', '\x128', '\a', '\x35', '\x2', '\x2', 
		'\x128', '\x33', '\x3', '\x2', '\x2', '\x2', '\x129', '\x12A', '\x5', 
		'H', '%', '\x2', '\x12A', '\x12B', '\a', '\x32', '\x2', '\x2', '\x12B', 
		'\x12C', '\x5', '\x30', '\x19', '\x2', '\x12C', '\x12D', '\a', '\x33', 
		'\x2', '\x2', '\x12D', '\x35', '\x3', '\x2', '\x2', '\x2', '\x12E', '\x12F', 
		'\a', '\xF', '\x2', '\x2', '\x12F', '\x130', '\x5', 'H', '%', '\x2', '\x130', 
		'\x37', '\x3', '\x2', '\x2', '\x2', '\x131', '\x137', '\x5', ':', '\x1E', 
		'\x2', '\x132', '\x137', '\a', '<', '\x2', '\x2', '\x133', '\x137', '\x5', 
		'\x42', '\"', '\x2', '\x134', '\x137', '\x5', '\x44', '#', '\x2', '\x135', 
		'\x137', '\a', '\v', '\x2', '\x2', '\x136', '\x131', '\x3', '\x2', '\x2', 
		'\x2', '\x136', '\x132', '\x3', '\x2', '\x2', '\x2', '\x136', '\x133', 
		'\x3', '\x2', '\x2', '\x2', '\x136', '\x134', '\x3', '\x2', '\x2', '\x2', 
		'\x136', '\x135', '\x3', '\x2', '\x2', '\x2', '\x137', '\x39', '\x3', 
		'\x2', '\x2', '\x2', '\x138', '\x13D', '\x5', '<', '\x1F', '\x2', '\x139', 
		'\x13D', '\a', '\x39', '\x2', '\x2', '\x13A', '\x13D', '\x5', '>', ' ', 
		'\x2', '\x13B', '\x13D', '\a', ';', '\x2', '\x2', '\x13C', '\x138', '\x3', 
		'\x2', '\x2', '\x2', '\x13C', '\x139', '\x3', '\x2', '\x2', '\x2', '\x13C', 
		'\x13A', '\x3', '\x2', '\x2', '\x2', '\x13C', '\x13B', '\x3', '\x2', '\x2', 
		'\x2', '\x13D', ';', '\x3', '\x2', '\x2', '\x2', '\x13E', '\x13F', '\a', 
		'\x38', '\x2', '\x2', '\x13F', '=', '\x3', '\x2', '\x2', '\x2', '\x140', 
		'\x141', '\a', ':', '\x2', '\x2', '\x141', '?', '\x3', '\x2', '\x2', '\x2', 
		'\x142', '\x143', '\a', '\x34', '\x2', '\x2', '\x143', '\x144', '\x5', 
		'\x30', '\x19', '\x2', '\x144', '\x145', '\a', '\x35', '\x2', '\x2', '\x145', 
		'\x41', '\x3', '\x2', '\x2', '\x2', '\x146', '\x147', '\t', '\a', '\x2', 
		'\x2', '\x147', '\x43', '\x3', '\x2', '\x2', '\x2', '\x148', '\x149', 
		'\a', '=', '\x2', '\x2', '\x149', '\x45', '\x3', '\x2', '\x2', '\x2', 
		'\x14A', '\x152', '\x5', 'H', '%', '\x2', '\x14B', '\x152', '\a', '\x3', 
		'\x2', '\x2', '\x14C', '\x152', '\a', '\x4', '\x2', '\x2', '\x14D', '\x152', 
		'\a', '\x5', '\x2', '\x2', '\x14E', '\x152', '\a', '\x6', '\x2', '\x2', 
		'\x14F', '\x152', '\a', '\a', '\x2', '\x2', '\x150', '\x152', '\a', '\b', 
		'\x2', '\x2', '\x151', '\x14A', '\x3', '\x2', '\x2', '\x2', '\x151', '\x14B', 
		...
		'\x2', '\x153', '\x154', '\a', '>', '\x2', '\x2', '\x154', 'I', '\x3', 
		'\x2', '\x2', '\x2', '!', 'M', 'S', 'Y', '`', 'h', 'j', 't', '}', '\x82', 
		'\x8C', '\x90', '\x9C', '\xA3', '\xA9', '\xAE', '\xB8', '\xC7', '\xCD', 
		'\xD6', '\xDE', '\xE9', '\xEB', '\xF6', '\xFD', '\x10C', '\x11D', '\x11F', 
		'\x125', '\x136', '\x13C', '\x151',
	};
