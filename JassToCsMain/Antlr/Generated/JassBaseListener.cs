...
public partial class JassBaseListener : IJassListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterBool_const([NotNull] JassParser.Bool_constContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="JassParser.bool_const"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitBool_const([NotNull] JassParser.Bool_constContext context) { }
	/// <summary>
