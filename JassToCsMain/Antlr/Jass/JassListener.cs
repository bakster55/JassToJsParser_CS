...
public interface IJassListener : IParseTreeListener {
	/// <summary>
	...
	/// <summary>
	/// Enter a parse tree produced by <see cref="JassParser.bool_const"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterBool_const([NotNull] JassParser.Bool_constContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="JassParser.bool_const"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitBool_const([NotNull] JassParser.Bool_constContext context);
	/// <summary>
